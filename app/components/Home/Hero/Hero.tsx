...
<div className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
  ...
  <div className="flex items-center justify-center flex-col w-full h-full">
    ...
    <Link href="#" className='relative  rounded px-14 md:px-28 -mt-4 py-2.5 overflow-hidden group bg-yellow-600  hover:bg-gradient-to-r  hover:from-yellow-500 text-white  hover:ring-2 hover:ring-offset-2 hover:ring-yellow-400 transition-all ease-out duration-300'>
